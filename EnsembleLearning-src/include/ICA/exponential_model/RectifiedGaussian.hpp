...
template<class T>
inline
typename ICR::ICA::RectifiedGaussian<T>::data_t
ICR::ICA::RectifiedGaussian<T>::CalcLogNorm(data_parameter mean, 
					    data_parameter mean_squared,
					    data_parameter precision)  
{ 
...
inline
typename ICR::ICA::RectifiedGaussian<T>::data_t
ICR::ICA::RectifiedGaussian<T>::CalcLogNorm(moments_parameter Mean,
					    moments_parameter Precision)  
{
...
inline
typename ICR::ICA::RectifiedGaussian<T>::data_t
ICR::ICA::RectifiedGaussian<T>::CalcLogNorm(NP_parameter NP)  
{
...
inline
typename ICR::ICA::RectifiedGaussian<T>::data_t
ICR::ICA::RectifiedGaussian<T>::CalcAvLog(moments_parameter Mean,
					  moments_parameter Precision,
					  moments_parameter Data)
{
...
ICR::ICA::RectifiedGaussian<T>::CalcSample(variable_parameter Mean,
					   variable_parameter Precision) 
{
...
template<class T>
typename ICR::ICA::RectifiedGaussian<T>::moments_t
ICR::ICA::RectifiedGaussian<T>::CalcSample(variable_vector_parameter m_mean_nodes,
...
inline
typename ICR::ICA::RectifiedGaussian<T>::moments_t
ICR::ICA::RectifiedGaussian<T>::CalcMoments(NP_parameter NP)
{
...
template<class T> 
inline
typename ICR::ICA::RectifiedGaussian<T>::NP_t
ICR::ICA::RectifiedGaussian<T>::CalcNP2Parent1(moments_parameter Precision,moments_parameter Data)
{
  BOOST_ASSERT(Precision.size() == 2);
...
inline
typename ICR::ICA::RectifiedGaussian<T>::NP_t
ICR::ICA::RectifiedGaussian<T>::CalcNP2Parent2(moments_parameter Mean,moments_parameter Data)
{
  BOOST_ASSERT(Mean.size() == 2);
  BOOST_ASSERT(Data.size() == 2);
...
inline
typename ICR::ICA::RectifiedGaussian<T>::NP_t
ICR::ICA::RectifiedGaussian<T>::CalcNP2Data(moments_parameter Mean,moments_parameter Precision)
{
  BOOST_ASSERT(Mean.size() == 2);
  BOOST_ASSERT(Precision.size() == 2);
  const data_t mean = Mean[0];
...
inline
typename ICR::ICA::RectifiedGaussian<T>::NP_t
ICR::ICA::RectifiedGaussian<T>::CalcNP2Parent(variable_parameter ParentA, 
					  deterministic_parameter Data, 
					  context_parameter C)
{
...
inline
typename ICR::ICA::RectifiedGaussian<T>::NP_t
ICR::ICA::RectifiedGaussian<T>::CalcNP2Deterministic(expression_parameter Expr,context_parameter C)
{
