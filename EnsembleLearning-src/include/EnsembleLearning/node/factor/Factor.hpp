...
namespace ICR{
  namespace EnsembleLearning{
	...
	typedef typename boost::call_traits< VariableNode<T,array_size>* const>::param_type
	variable_parameter;
	typedef typename boost::call_traits< VariableNode<T,array_size>* const>::value_type
	variable_t;
	...
	Moments<T,array_size>  //The return type
      InitialiseMoments() const
      {
